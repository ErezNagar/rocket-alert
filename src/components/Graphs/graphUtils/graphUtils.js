...
const isYemenMissileAttackTimeFrame = (date) => {
  ...
  const YemenAttackTimeframes = [
    ...
    [new Date("2025-07-10 05:19:00"), new Date("2025-07-10 05:21:00")],
    [new Date("2025-07-16 20:43:00"), new Date("2025-07-16 20:44:00")],
    [new Date("2025-07-18 22:24:00"), new Date("2025-07-18 22:25:00")],
    [new Date("2025-07-22 05:50:00"), new Date("2025-07-22 05:51:00")],
    [new Date("2025-07-25 21:38:00"), new Date("2025-07-25 21:39:00")],
    [new Date("2025-07-29 20:32:00"), new Date("2025-07-29 20:34:00")],
    ...
    [new Date("2025-08-22 16:12:00"), new Date("2025-08-22 16:21:00")],
    [new Date("2025-08-22 16:12:00"), new Date("2025-08-22 16:31:00")],
  ];
