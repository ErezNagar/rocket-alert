...
const TimeToShelter = ({ alerts }) => {
  ...
  useEffect(() => {
    ...
    const text =
      alertDistance > 5
        ? `If this was happening in your area, this means a rocket targeting you was shot roughly ${alertDistance} km (${alertDistanceInKM} miles) away`
        : `If this was happening in your area, this means a rocket targeting you was shot less than 5 km (${alertDistanceInKM} miles) away`;
    ...
    const timeToShelterShareText =
      alertDistance > 5
        ? `If this was happening in MY area, this means a rocket targeting me would've been shot roughly ${alertDistance} km (${alertDistanceInKM} miles) away`
        : `If this was happening in MY area, this means a rocket targeting me would've been shot less than 5 km (${alertDistanceInKM} miles) away`;
